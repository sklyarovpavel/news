package ru.gosuslugi.rss.config;
...
public class CrawlerProperties {
    ...
    public static class Source {
        @NotBlank
        private String rssUrl = "https://info.gosuslugi.ru/rss/";
        @NotBlank
        private String userAgent = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36";
        private String accept = "application/rss+xml, application/xml;q=0.9, */*;q=0.8";
        private String acceptLanguage = "ru-RU,ru;q=0.9";
        // Часовой пояс по умолчанию, если в RSS нет смещения в pubDate
        @NotBlank
        private String defaultZoneId = "Europe/Moscow";
    }
}
